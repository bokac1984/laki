<?php
    ...
    //echo "<br>profffffffffffffffffffID = ". $profId;
...
<table id="students">
    ...
    {?>
    <tr style="cursor:default" onMouseOut="this.bgColor='#FFFFFF'" onMouseOver="this.bgColor='#999999'" onclick="window.opener.document.myform.predmet_id.value='<? echo $red['id']; ?>';window.opener.document.myform.naziv_predmeta.value='<? echo  $red['naziv_predmeta']; ?>';window.close();">
    ...
    <? } ?>
    <tr><td></td></tr>
    <tr><td colspan="5"><? $dbManip->doPageslist(20,'/rfid_manager/predmet_list.inc.php','',$totalresult); ?></td></tr>
</table>
